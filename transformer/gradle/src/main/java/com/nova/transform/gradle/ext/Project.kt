package com.nova.transform.gradle.ext
...
import com.nova.transform.gradle.compat.getAndroidOrNull
...
private object EmptyAttributes : AttributeContainer {
    ...
    override fun <T : Any?> attribute(key: Attribute<T>, value: T & Any): AttributeContainer = this
